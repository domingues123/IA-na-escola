export const perguntas = [
    {
        ...
        alternativas: [
            {
                texto: "2 xicras de de canjica de milho",
                afirmacao: [
                    "No início ficou com medo do que essa canjica poderia ficar ruim.",
                    "Achou assustador pensar na velocidade na qual as  pessoas come canjica"
                ],
                proxima: 1,
            },
            {
                texto: "oleo de motor",
                afirmacao: [
                    "voçê deve estar enlouquecendo",
                    "Pensou que oleo pode ser bom na sua vida."
                ],
                proxima: 2,
            },
        ]
    },
    {
        ...
        alternativas: [
            {
                texto: "2 litros de agua",
                afirmacao: [
                    "dai Conseguiu utilizar o ultimo litro de agua",
                    "isso ai",
                    "dois litros de agua é o suficiente"
                ],
                proxima: 3,
            },
            {
                texto: "grama contaminada",
                afirmacao: [
                    "você é louco?",
                    "voê ja comeu isso?",
                    "que?"
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "1 xicara de acucar",
                afirmacao: [
                    ". acucar para ficar bem docinho",
                    "sem acucar é horrivel"
                ],
                proxima: 5,
            },
            {
                texto: "pregos enferrujados",
                afirmacao: [
                    "que canjica é essa?",
                    "quer morrer?"
                ],
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "1 litro de leite",
                afirmacao: [
                    ". leite é bom, ainda mais quando é denso",
                    "o de saquinho eu recomendo"
                ],
                proxima: 7,
            },
            {
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "leite condensado e creme de leite",
                afirmacao: [
                    "Notou também que muitas pessoas não sabem ainda fazer uma canjiquinha tradicional ",
                    "Ainda acha que os meios de fazer canjica tradicional são mais eficazes para a criatividade, por isso vem estimulando pessoas em suas redes sociais a fazer canjica."
                ],
            },
            {
                texto: "geladeira da sansung.",
                afirmacao: [
                    "...voce é uma pessoa?",
                    "você é vivo?",
                    "..."
